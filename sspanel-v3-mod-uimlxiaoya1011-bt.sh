...
wget -N --no-check-certificate "https://raw.githubusercontent.com/dogwalkerg/sh/master/lxiaoya1011.zip"
unzip lxiaoya1011.zip
cd lxiaoya1011
mv * .[^.]* /www/wwwroot/$website/
cd ..
rm -rf lxiaoya1011.zip lxiaoya1011/
