...
wget -N --no-check-certificate "https://raw.githubusercontent.com/dogwalkerg/sh/master/lxiaoya10011.zip"
unzip lxiaoya10011.zip
cd lxiaoya10011
mv * .[^.]* /www/wwwroot/$website/
cd ..
rm -rf lxiaoya10011.zip lxiaoya10011/
...
echo -e "${Info} 默认生成的管理员用户名：golo123 密码为1234567890"
